...
// The Buffer Threshold's were set according to the KM Paper (Page 5 and 4th Paragraph)
var B_min = 10;		
var B_low = 20;
var B_high = 50;
var B_opt = 40;		// this is set bcz of "0.5*(B_low + B_high)"

/*Safty Margines for KM Algo - Set according to the paper evaluation Section - Alwayd stays between [0,1].*/
var alpha_1 = 0.75;
var alpha_2 = 0.33;
var alpha_3 = 0.50;
var alpha_4 = 0.75;
