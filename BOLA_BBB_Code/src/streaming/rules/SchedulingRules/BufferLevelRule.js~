...
/********** Function to GET the Mimimum Required Buffer Thresholds - Hema ************/
...
/********** Function to Set the Buffer Thresholds - Hema ************/
...
/*Hema - The "fragmentCount" is set to one focefully, to Nullify the BufferLevelRule. The Buffer Rule can be dealt in the SARA Function. */
/********* DON'T Touch This Code ******/
fragmentCount = 1;
/************************************/
            callback(new MediaPlayer.rules.SwitchRequest(fragmentCount, MediaPlayer.rules.SwitchRequest.prototype.STRONG));
        },
