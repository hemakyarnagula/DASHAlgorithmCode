...
Dash.dependencies.RepresentationController = function () {
    ...
    var data = null,
		...
		//aR=availableRepresentations;console.log(aR.length);
		if(type1 == "audio")
		{
			aaR=availableRepresentations;//console.log(aaR.length);
			//acur=parseInt(quality.toString());
			//console.log(quality.toString()+'qualrepaudio');
			return availableRepresentations[quality];
		}
		else
		{
			aR=availableRepresentations;//console.log(aR.length);
			//cur=parseInt(quality.toString());
			if(lflag==0)
			lflag=1;
			//console.log(quality.toString()+'qualrepvideo');
			return availableRepresentations[quality];
		}
