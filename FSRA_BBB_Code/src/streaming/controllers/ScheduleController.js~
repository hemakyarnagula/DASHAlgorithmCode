...
//console.log("Calling Validate function from --> doStart.");
            validate.call(this);
        },
...
//console.log("Hello Hema, You are here in ScheduleController Function..");


/*This is Very Importent Function for playing the Content*/
            self.rulesController.applyRules(rules, self.streamProcessor, callback, null, function(currentValue, newValue) {   return newValue;    });
...
//console.log("Check Point 2 ");
        ...
        validate = function () {
            var now = new Date().getTime(),
                ...
                qualitySwitchThreshold = 1; //TODO need to get average segment duration and cut that in half for interval to apply rule. Previous Value is 1000.

//console.log("At the Validate function for each segment...");
...
//console.log("Calling Validate function from --> onStreamCompleted.");
            validate.call(self);
        },
...
//console.log("Calling Validate function from --> onBufferLevelUpdated.");
            validate.call(this);
        },
...
//console.log("Calling Validate function from --> onWallclockTimeUpdated.");
            validate.call(this);
        },
